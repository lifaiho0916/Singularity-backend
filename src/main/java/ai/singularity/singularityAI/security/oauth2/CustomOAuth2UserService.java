package ai.singularity.singularityAI.security.oauth2;

import ai.singularity.singularityAI.exception.OAuth2AuthenticationProcessingException;
...
import ai.singularity.singularityAI.security.oauth2.user.OAuth2UserInfo;
import ai.singularity.singularityAI.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        ...
        user.setFirst_name(oAuth2UserInfo.getFirstName());
        user.setLast_name(oAuth2UserInfo.getLastName());
